...
const THANK_YOU_MESSAGE =
  'Thank you for your request. Would you like to see suitable alternatives, complementary items, and a newsletter offer?'

const THANK_YOU_BUTTONS = [
  { id: 'thank_you_recommendations', label: '🎁 Show recommendations' },
] as const

export type ThankYouActionId = (typeof THANK_YOU_BUTTONS)[number]['id']
...
interface ThankYouNotificationProps {
  ...
  onDismiss: () => void
  onAction: () => void
  onButtonClick?: (actionId: ThankYouActionId) => void
}
...
export default function ThankYouNotification({
  ...
  const handleButtonClick = (actionId: ThankYouActionId) => {
  ...
  if (variant === 'desktop') {
    return (
      <div
        ...
        role="dialog"
        aria-label="Thank you page suggestion"
      >
